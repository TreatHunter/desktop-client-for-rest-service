...
public class AddCaliberDialog extends JDialog {
    private boolean createdEntity = false;
    private Caliber caliber;

    public AddCaliberDialog(JDialog owner) {
        super(owner,"Добавить новый калибр",true);
        ...
        btnAccept.addActionListener(event -> {
            ...
            caliber.setName(tfName.getText());
            ...
            caliber.setDescription(tfDescription.getText());
